...
public class MyListView extends ListView implements OnScrollListener {
	...
	public enum ListState {
		RELEASE_To_REFRESH, PULL_To_REFRESH, REFRESHING, DONE, LOADING,
	}
	...
	private void init(Context context) {
		...
		loadMore_pb = (ProgressBar) footView.findViewById(R.id.footview_pb);
		loadMore_tv = (TextView) footView.findViewById(R.id.footview_tv);
	...
	// 加载更多方法之前需要调用的方法
	public void setLoadMoreBefore() {
		isRefreshable = false;
		isCanAdd = false;
		footView.setVisibility(View.VISIBLE);
		loadMore_pb.setVisibility(View.VISIBLE);
		loadMore_tv.setText("正在加载中...");

	}

	// 加载更多方法之前需要调用的方法
	public void setLoadMoreAfter() {
		isRefreshable = true;
		isCanAdd = true;
		footView.setVisibility(View.INVISIBLE);
	}
	...
	public void onScrollStateChanged(AbsListView view, int scrollState) {
		if (state==ListState.DONE&&isBottom && scrollState == SCREEN_STATE_ON) {
			loadMore_pb.setVisibility(View.INVISIBLE);
			loadMore_tv.setText("加载更多");

		} else {
			footView.setVisibility(View.INVISIBLE);
		}
		if (state==ListState.DONE&&isBottom && scrollState == SCROLL_STATE_IDLE && isCanAdd) {
			if (callback != null) {
				setLoadMoreBefore();
				callback.getState();
